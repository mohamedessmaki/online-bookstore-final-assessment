...
GitHub Actions workflow at `.github/workflows/ci.yml` installs dependencies and runs pytest on every push and pull request. The workflow fails if any test fails.
